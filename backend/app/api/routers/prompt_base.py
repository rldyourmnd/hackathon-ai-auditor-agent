...
from app.models.prompts import (
    ...
    PromptRelationCreate, PromptRelationRead
)
...
async def add_prompt(prompt_data: PromptCreate):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to add prompt to prompt-base")
    ...
    try:
        ...
        return {
            ...
            "analysis": {
                ...
                "recommendation": "safe_to_add" if len(existing_prompts) < 3 else "review_recommended"
            }
        }
        
    except Exception as e:
        logger.error(f"Failed to check prompt conflicts: {e}")
        raise HTTPException(status_code=500, detail="Failed to analyze prompt conflicts")
...
async def get_prompt_relations(prompt_id: str):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to retrieve prompt relations")
